  ...
  void _expirePayment() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Waktu pembayaran telah habis. Silakan buat pesanan baru.'),
        actions: [
          TextButton(
            onPressed: () {
  ...
  Future<void> _completePayment() async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Bukti pembayaran telah dikirim. Pesanan Anda sedang diproses.'),
        actions: [
          TextButton(
            onPressed: () {
              Navigator.pop(context); // Close dialog
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '4. Pembayaran akan diverifikasi dalam 1x24 jam',
