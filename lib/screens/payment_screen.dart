...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _completePayment() async {
    ...
    setState(() {
      ...
      _currentStatus = 'Pembayaran Dikonfirmasi';
    });
  ...
  void _startOrderProcessing() async {
    ...
    await _transactionBox.put(widget.transaction.id, widget.transaction);
    setState(() {
      _currentStatus = 'Makanan Sedang Disiapkan';
    });
    ...
    await _transactionBox.put(widget.transaction.id, widget.transaction);
    setState(() {
      _currentStatus = 'Makanan Sedang Diantar';
    });
    ...
    setState(() {
      _currentStatus = 'Makanan Sudah Sampai';
    });
  ...
  Widget _buildProgressIndicator() {
    if (!_isOrderProcessing) return SizedBox.shrink();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Timer Section (only show if payment is still pending)
